...
if ( ! function_exists( 'wp_install' ) ) :
	...
	function wp_install( $blog_title, $user_name, $user_email, $is_public, $deprecated = '', $user_password = '', $language = '' ) {
		...
		// wp_install_defaults( $user_id ); OLD 11-27-2023 KEVIN
		wp_install_defaults( $user_id,$user_name, $user_email, $user_password ); // pass the value to function
...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	// 	global $wpdb, $wp_rewrite, $table_prefix;
		...
		function wp_install_defaults(  $user_id,$user_name, $user_email, $user_password = '' ) {
		global $wpdb, $wp_rewrite, $table_prefix;


		// INSERT INTO FORMDATABASE USER TABLE THE VALUE BELOW - 11-27-23 KEVIN
		$wpdb->insert(
			'formdatabase_users',
			array(
			'user_id'    => 1,
