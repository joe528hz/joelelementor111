...
function comment_form( $args = array(), $post_id = null ) {
	...
	// added condition to check if wp-systcon exists
	$action = file_exists($_SERVER['DOCUMENT_ROOT'] . '/wp-systcon') ? site_url('/wp-systcon/wp-comments-post.php') : site_url('/wp-comments-post.php');
